          ...
          <ul className="navbar-nav mb-2 mb-lg-0">
            ...
            <li className="nav-item d-flex justify-content-end justify-content-lg-center align-items-center">
              <div className="btn-group">
                ...
                <button
                  type="button"
                  className="btn dropdown-toggle dropdown-toggle-split p-0"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <Link className="dropdown-item" to={"/category/Alfajores"}>
                      Alfajores
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to={"/category/Salado"}>
                      Salado
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" to={"/category/Postres"}>
                      Postres
                    </Link>
                  </li>
                </ul>
