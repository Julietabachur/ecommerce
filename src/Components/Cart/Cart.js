  ...
  return (
    <>
        ...
        <div className="d-flex justify-content-center align-items-center">
          {cartProducts.length !== 0 ? <button className="d-flex flex-row justify-content-center align-items-center botones border border-dark border-4 rounded-3" onClick={clear}><IoTrash onClick={clear}/>Vaciar carrito</button> 
          :
